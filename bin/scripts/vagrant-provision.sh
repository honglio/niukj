...
apt-get install -y mongodb-org=2.7.8 mongodb-org-server=2.7.8 mongodb-org-shell=2.7.8 mongodb-org-mongos=2.7.8 mongodb-org-tools=2.7.8
...
echo "alias nkj='env-reload;cd /vagrant;make'" >> /home/vagrant/.bash_profile
